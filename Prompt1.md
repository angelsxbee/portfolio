Use this prompt to create the ripple effect only
...
File location: components/background-ripple-effect-demo.tsx
...
File location: components/ui/background-ripple-effect.tsx
